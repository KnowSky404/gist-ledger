        ...
        <div className="flex gap-3 pt-1">
          ...
          <button
            ...
            className={cn(
              ...
              type === 'expense' ? 'bg-rose-50 dark:bg-rose-950/300 hover:bg-rose-600 shadow-rose-200' : 'bg-emerald-50 dark:bg-emerald-950/300 hover:bg-emerald-600 shadow-emerald-200',
